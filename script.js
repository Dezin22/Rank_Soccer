...
const columnCount = 3;
const columns = [
  document.getElementById("ranking-list-1"),
  document.getElementById("ranking-list-2"),
  document.getElementById("ranking-list-3"),
];

teams.forEach((team, index) => {
  const listItem = document.createElement("li");
  listItem.textContent = `${team.name} - R$ ${team.value} mi`;
